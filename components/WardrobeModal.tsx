...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
  ...
  return (
    <div className="pt-6 border-t border-gray-400/50">
        <h2 className="text-xl font-serif tracking-wider text-gray-800 mb-2">Wardrobe</h2>
        <p className="text-sm text-gray-600 mb-4">
            Upload an image of a clothing item (e.g., a shirt, jacket, or dress) to see how it looks on your portrait.
        </p>

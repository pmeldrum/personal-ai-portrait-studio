      ...
      {!userImageUrl ? (
        ...
        >
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 leading-tight">
                Your Personal AI Portrait Studio.
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Need a new LinkedIn headshot or a fresh look for social media? Upload a photo to create your personal AI avatar and generate stunning, professional portraits in minutes.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Upload a clear photo of yourself. For best results, use a full-body or upper-body shot where your face is visible.</p>
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center">
            <Compare
              firstImage="https://raw.githubusercontent.com/pmeldrum/personal-ai-portrait-studio/refs/heads/main/assets/pm-original.jpg"
              secondImage="https://raw.githubusercontent.com/pmeldrum/personal-ai-portrait-studio/refs/heads/main/assets/pm-professional.png"
              slideMode="drag"
